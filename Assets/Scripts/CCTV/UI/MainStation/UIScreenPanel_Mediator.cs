...
public class UIScreenPanel_Mediator : Mediator
{
    #region 字段
    private static string Name = "UIScreenPanel_Mediator";
    #endregion

    #region 构造函数
    public UIScreenPanel_Mediator() : this(null, null)
    {

    }
    public UIScreenPanel_Mediator(string mediatorName, object viewComponent = null) : base(mediatorName, viewComponent)
    {
