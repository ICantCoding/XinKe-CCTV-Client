...
public class UILoginPanel_Mediator : Mediator
{
    #region 字段
    private static string Name = "UILoginPanel_Mediator";
    #endregion

    #region 构造函数
    public UILoginPanel_Mediator() : this(null, null)
    {

    }
    public UILoginPanel_Mediator(string mediatorName, object viewComponent = null) : base(mediatorName, viewComponent)
    {
